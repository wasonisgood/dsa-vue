<template>
  <div>
    ...
    <div class="sticky d-block d-lg-none">
      <nav
        class="navbar navbar-dark navbar-expand-lg d-flex flex-column align-items-center bd-navbar bar shadow"
      >
        <div class="d-flex justify-content-between w-100">
          ...
          <button
            ...
            data-target="#collapseToggler"
            aria-controls="collapseToggler"
            aria-expanded="false"

        ...
        <div style="width:100%; height:80vh; padding: 15px 0; overflow-x: hidden;" id="phone-body">
            <div class="container-fluidcontainer-on-phone h-100">
                <div class="row h-lg-60">
                    <div id="system-header" class="h-lg-100 w-lg-60 w-xs-100 content">
                    ...
                    <div id="orderTable-header" class="h-lg-100 w-lg-40 w-xs-100 content">
                        <div class="content-body">
                ...
                <div class="row h-lg-40">
                    <div id="nowPowerChart-header" class="h-lg-100 w-lg-20 w-xs-100 content">
                        <div class="content-body">
                            ...
                            <div class="w-lg-90" v-show="nowPowerChart.flag" id="nowPowerChart">
                                ...
                                <div class="h-lg-90 w-lg-100 w-xs-100">
                                    <div class="h-lg-100 nowPower-panel">
                                        <div class="h-lg-100 now-Power-content">
                                            <span id="nowPower-Value" class="h-lg-10"></span>
                                            <div class="innerContent h-lg-80">
                                                <canvas id="nowPower" class="h-lg-80"></canvas>
                                            </div>
                    ...
                    <div id="totalPower-header" class="h-lg-100 w-lg-20 w-xs-100 content">
                        <div class="content-body">
                    ...
                    <div id="blockMW-header" class="h-lg-100 w-lg-20 w-xs-100 content">
                        <div class="content-body">
                    ...
                    <div id="machineUtilizationRate-header" class="h-lg-100 w-lg-20 w-xs-100 content">
                        <div class="content-body">
                    ...
                    <div id="resultAnalysis-header" class="h-lg-100 w-lg-20 w-xs-100 content">
                        <div class="content-body">
...
export default {
    ...
    mounted() {
        ...
        import("./js/nowPower.js");
        import("./js/resultAnalysis.js");
        if (window.innerWidth < 992) {
            setTimeout(() => {
                this.Toggle(this.orderTable)
                this.Toggle(this.nowPowerChart)
                this.Toggle(this.totalPower)
                this.Toggle(this.blockMW)
                this.Toggle(this.machineUtilizationRate)
                this.Toggle(this.resultAnalysis)
            }, 500);
        }
    },
    methods: {
